...
export default function Header() {
  ...
  useEffect(() => {
    ...
    document.body.style.overflowY =
      isMobileNavOpen + isLoginOpen + isSignupOpen ? "hidden" : "auto";
    return () => {
    ...
    <header className="w-full">
      <div className="flex px-6 md:px-12 py-4 justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <button onClick={() => setIsLoginOpen(true)} className="button2">
            Login
          </button>
          <button onClick={() => setIsSignupOpen(true)} className="button1">
            Sign Up
          </button>
        </nav>
